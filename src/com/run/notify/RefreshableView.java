...
public class RefreshableView extends LinearLayout implements OnTouchListener {
	...
	public RefreshableView(Context context, AttributeSet attrs) {
		...
		description = (TextView) header.findViewById(R.id.refresh_desc);
		refreshAt = (TextView) header.findViewById(R.id.refresh_at);		
     ...
     */ 
	// ??事件返回 true false 有什么作用
	@Override
	public boolean onTouch(View v, MotionEvent event) {
		SetIsAbleToPull(event);
		//Log.i("refresh", " " + ableToPull);
		if (ableToPull) {
			...
			case MotionEvent.ACTION_MOVE:
				...
				// Log.i("refresh", "move: " + yMove + " down: " + yDown);
...
//					yDown = event.getRawY();
//				}
				// 如果listview中首元素的上边缘距离父布局的值为0.说明当前listview滚动到了顶部,可以下拉刷新				
				ableToPull = true;
			} else {
	...
	private void refreshUpdatedAtValue() {
		...
		refreshAt.setText(updateAtValue);
	}
